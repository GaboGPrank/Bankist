...
const account1 = {
  ...
  movementsDates: [
    ...
    '2023-11-15T14:11:59.604Z',
    '2023-11-16T17:01:17.194Z',
    '2023-11-19T20:36:17.929Z',
    '2023-11-20T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
const formatMovements = function(date, locale = 'es-ES'){
  const daysPassed = (date1, date2) => 
    Math.round(Math.abs(date2 - date1) / (24 * 3600 * 1000));
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const formattedMov = formatCurrency(mov, acc);
